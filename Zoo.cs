	...
	public class Zoo
{
    ...
    public void AddAnimal()
    {
        ...
        Console.WriteLine("Nhập loài động vật:");
        string speciesName = Console.ReadLine();
        Specie species = Species.FirstOrDefault(s => s.Name == speciesName);

        if (species == null)
        {
            Console.WriteLine("Loài chưa có. Hãy thêm loài:");
        ...
        // Chọn chuồng
        var suitableCages = Cages.Where(c => c.Type == speciesName && c.HasSpace()).ToList();
        Cage selectedCage;
        ...
        else
        {
            ...
            selectedCage = AddCage(speciesName);
        }
